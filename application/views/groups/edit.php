					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Edit group</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form action="/groups/save" method="POST" class="form-horizontal">
									<input type="hidden" name="id" value="<?php echo $obj->id;?>">
									<div class="control-group">
										<label class="control-label">Nama</label>
										<div class="controls">
											<input type="text" name="name" class="span6 m-wrap" value="<?php echo $obj->name;?>"/>
